# HTMXS
A lightweight client-side companion for htmx that adds targeted micro-updates, DOM morphing, script execution in partials, and native browser device APIs.
